...
interface TelegramApi {
	 ...
	 */
	fun sendMessage(message: TextMessage): Message
	 ...
	 */
	fun copyMessage(message: CopyMessage): MessageId

	/**
	 * Use this method to forward messages of any kind. Service messages can't be forwarded.
	 * On success, the sent Message is returned.
	 */
	fun forwardMessage(message: ForwardMessage): Message
	 ...
	 * to the original message. Returns the MessageId of the sent message on success.
	 */
	fun sendPhoto(message: PhotoMessage): Message
	 ...
	 */
	fun sendAudio(message: AudioMessage): Message

	/**
	 * Use this method to send general files. On success, the sent Message is returned.
	 * Bots can currently send files of any type of up to 50 MB in size, this limit may be changed in the future.
	 */
	fun sendDocument(message: DocumentMessage): Message
	 ...
	 */
	fun sendVideo(message: VideoMessage): Message
	 ...
	 */
	fun sendAnimation(message: AnimationMessage): Message
	 ...
	 */
	fun sendVoice(message: VoiceMessage): Message

	/**
	 * As of v.4.0, Telegram clients support rounded square mp4 videos of up to 1 minute long.
	 * Use this method to send video messages. On success, the sent Message is returned.
	 */
	fun sendVideoNote(message: VideoNoteMessage): Message
	 ...
	 */
	fun sendMediaGroup(message: MediaGroupMessage): List<Message>

	/**
	 * Use this method to send point on the map. On success, the sent Message is returned.
	 */
	fun sendLocation(message: LocationMessage): Message

	/**
	 * Use this method to send information about a venue. On success, the sent Message is returned.
	 */
	fun sendVenue(message: VenueMessage): Message

	/**
	 * Use this method to send phone contacts. On success, the sent Message is returned.
	 */
	fun sendContact(message: ContactMessage): Message
